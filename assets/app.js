...
const govCopy = {
  strategy: {
    ...
    example: "Approves HR AI North Star + budget."
  },
  standards: {
    title: "Standards (CoE)",
  ...
  council: {
    ...
    example: "Council reviews bias test results before launch."
  },
  guardrails: {
